...
public class contributii_angajat extends javax.swing.JFrame {
    ...
    /** Creates new form contributi_angajati */
    ...
    private void jTextField7KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField7KeyReleased
        ...
        double procent_asigurari_sociale = 10.5;
        double procent_asigurari_sociale_sanatate = 5.5;
    ...
    public void afiseaza_salariu_net() {
        ...
        impozit_venit = ((salariu - asigurari_sociale - asigurari_sociale_sanatate - fond_somaj-deducere())/100 * procent_impozit_venit); 
        jTextField6.setText(String.valueOf(impozit_venit));
        salariu_net = (salariu - asigurari_sociale - asigurari_sociale_sanatate - fond_somaj - impozit_venit);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String fond_somaj = jTextField4.getText();
        ...
        JFileChooser dialog = new JFileChooser();
           ...
           myDocument.add(new Paragraph("Raport generat privind contributiile angajatului si a angjatorului",FontFactory.getFont(FontFactory.TIMES_BOLD,20,Font.BOLD )));
           ...
           myDocument.add((new Paragraph("Fondul de Somaj (CFS): " + fond_somaj,FontFactory.getFont(FontFactory.TIMES_ROMAN,10,Font.PLAIN))));
           ...
           myDocument.add((new Paragraph("Fondul de Somaj (CFS): " + contributii_angajator.fond_somaj,FontFactory.getFont(FontFactory.TIMES_ROMAN,10,Font.PLAIN))));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(contributii_angajat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
